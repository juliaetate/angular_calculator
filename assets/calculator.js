...
(function(){
  ...
  app.controller('CalculatorController', ['$scope', function($scope){
    ...
    $scope.calculate = function() {
      ...
      $scope.inc_price = ( ( ($scope.inc_wattage * total_hours) / 1000 ) * cost ).toFixed(2);
      $scope.hal_price = ( ( ($scope.hal_wattage * total_hours) / 1000 ) * cost ).toFixed(2);
      $scope.cfl_price = ( ( ($scope.cfl_wattage * total_hours) / 1000 ) * cost ).toFixed(2);
      $scope.led_price = ( ( ($scope.led_wattage * total_hours) / 1000 ) * cost ).toFixed(2);
    }
